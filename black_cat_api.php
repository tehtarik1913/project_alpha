...
require('trackingmore_API/tracking/track.class.php/Init.class.php');
require_once("trackingmore_API/tracking/track.class.php/Init.class.php");

# Pass api key parameter
\APITracking\Api::setApiKey("a65228a9-a721-4fc0-acad-abe504cd4722");

# Get a tracking number of real-time query result data
// $data = ["tracking_number" => "RP325552475CN", "carrier_code" => "dhl"];
